...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('admin_locking', ['Lock'])
        ...
        db.send_create_signal('admin_locking', ['ObjectChangelog'])


    def backwards(self, orm):
        
        # Deleting model 'Lock'
        db.delete_table('admin_locking_lock')

        # Deleting model 'ObjectChangelog'
        db.delete_table('admin_locking_objectchangelog')
    ...
    models = {
        'admin_locking.lock': {
            ...
            'until': ('django.db.models.fields.FloatField', [], {})
        },
